...
//        threeColTable1.addCell(new Cell().add("Prix").setBold().setFontColor(Color.WHITE).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
...
//        List<Integer> montantParTache = null ;
//
//        float totalSum = 0;
...
//            totalSum =+total;
//
//            taches.add(enregistrementList.get(i).getTache());
//
